...
const CardContent = (props) => {
 ...
 return (
    <div><div className="absolute top-0 left-0  h-full w-full p-6 flex flex-col justify-between">
        <h2 className="bg-white h-10 w-10 rounded-full flex justify-center items-center font-semibold ">{props.id}</h2>
        <div>
            ...
            <button className="bg-blue-300 rounded-full px-8 py-3 font-semibold">{props.tag}</button>
            <button className="bg-blue-300 rounded-full px-4 py-3 "><i className="ri-arrow-right-line"></i></button>
        </div>
        </div>
